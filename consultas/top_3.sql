...
BEGIN
    ...
    -- SERIE
    SELECT * FROM (SELECT series.sid, series.nombre, COUNT(series.sid) as cuenta
    ...
    AND proveedores_serie.pro_id = proveedor.pro_id AND proveedor.nombre = 'Viu' GROUP BY series.sid) as p ORDER BY -cuenta LIMIT 3;
