...
<?php 
    ...
    $tipo = $_POST["tipo"];
 	...
 	$query2 = "SELECT series.sid, nombre, clasificacion, ano, genero_s.genero
     FROM series, genero_s
     WHERE genero_s.genero = '$tipo'
     AND series.sid = genero_s.sid
     UNION
     SELECT series.sid, nombre, clasificacion, ano, genero_s.genero 
...
<br/><br/>
      ...
      <?php
        echo "<h1 class='text-white d-flex justify-content-center'> Series: </h1><br/>";
