...
<?php 
    ...
    foreach($consulta as $yapa) {
 	...
 	$query2 = "aca va la query de juegos activos (la variable id, te entrega el id de la sesión)";
...
<?php 
    echo "<h1 class='text-white d-flex justify-content-center'> Juegos con Suscripción Activa según Fecha: </h1>";
